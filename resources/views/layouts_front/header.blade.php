                  ...
                  <div class="menu">
                     ...
                     <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                        <ul id="menu-mobil-menu" class="nav navbar-nav" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                           ...
                           @if (Route::has('login'))
                               @auth
                               <li  id="menu-item-1163" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1163 nav-item"><a href="{{ url('/home') }}" class="nav-link"><span itemprop="name">Tableau de bord</span></a></li>
                               @else
                               <li  id="menu-item-1433" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1433 nav-item"><a href="{{ route('login') }}" class="nav-link"><span itemprop="name">Connexion</span></a></li>

                                   @if (Route::has('register'))
                                   <li  id="menu-item-1433" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1433 nav-item"><a href="{{ route('register') }}" class="nav-link"><span itemprop="name">S'enregistrer</span></a></li>
                                   @endif
                               @endauth
                             @endif
                        </ul>
