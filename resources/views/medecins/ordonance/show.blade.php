...
@section('title', $consultation->exists ? "Details de la Consultation" : "Ajouter une consultation")
@section('contenu')
            ...
            <form  action="{{route($consultation->exists ? 'medecins.consultation.update' : 'medecins.consultation.store', $consultation)}}" method="post" class="vstack gap-2" enctype="multipart/form-data" class="row g-4 needs-validation" novalidate="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" placeholder="Référence du rendez-vous" value="{{ old('code', $consultation->code) }}" disabled>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="select2 js-states form-control @error('patient_id') is-invalid @enderror" id="patient_id" name="patient_id" disabled>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('status') is-invalid @enderror" id="status" name="status" placeholder="Statut de la consultation" value="{{ old('status', $consultation->status) }}" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('motif') is-invalid @enderror" id="motif" name="motif" placeholder="Motif de la consultation" value="{{ old('motif', $consultation->motif) }}" disabled>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('frais') is-invalid @enderror" id="frais" name="frais" placeholder="Frais de la consultation" value="{{ old('frais', $consultation->frais) }}" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('examen_complementaire') is-invalid @enderror" id="examen_complementaire" name="examen_complementaire" placeholder="Examen Complémentaire" disabled>{{ old('examen_complementaire', $consultation->examen_complementaire) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('suivi_recommande') is-invalid @enderror" id="suivi_recommande" name="suivi_recommande" placeholder="Suivi Recommandé" disabled>{{ old('suivi_recommande', $consultation->suivi_recommande) }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('resultat') is-invalid @enderror" id="resultat" name="resultat" placeholder="Résultat de la consultation" disabled>{{ old('resultat', $consultation->resultat) }}</textarea>
