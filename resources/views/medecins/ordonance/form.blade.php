                ...
                <select class="select2 js-states form-control @error('consultation_id') is-invalid @enderror" id="consultation_id" name="consultation_id">
                    @foreach($consultations as $consultation)
                        @if (Auth::user()->id === $consultation->rdv->medecin->user_id)
                            <option value="{{ $consultation->id }}" data-consultation="{{ $ordonance->consultation_id }}" {{ $consultation->consultation_id == $consultation->id ? 'selected' : '' }}>
        ...
        <div id="ordonnances">
            <div class="row ordonnance">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="text" class="form-control @error('ordonnances[0][mode_utilisation]') is-invalid @enderror" id="mode_utilisation" name="ordonnances[0][mode_utilisation]" placeholder="Mode d'utilisation" value="{{ old('ordonnances[0][mode_utilisation]', $ordonance->mode_utilisation) }}">
