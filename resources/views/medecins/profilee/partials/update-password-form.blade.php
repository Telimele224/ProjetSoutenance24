<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Mot de passe actuele')" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password" name="password" type="password" class="class" autocomplete="new-password" />
