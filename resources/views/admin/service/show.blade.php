  ...
  <div class="row">
      <div class="col">
              <div class="sidebar-service wow fadeInLeft" data-wow-delay="0.8s">   
                                                      <span class="menu-service " onclick="location.href='../urology/index.html';"><a href="../urology/index.html"><i class="flaticon-right-chevron"></i>Urology</a></span>         
                                      <span class="menu-service menuactive" onclick="location.href='index.html';"><a href="index.html"><i class="flaticon-right-chevron"></i>Gastroenterology</a></span>         
                                      <span class="menu-service " onclick="location.href='../chest-diseases/index.html';"><a href="../chest-diseases/index.html"><i class="flaticon-right-chevron"></i>Chest Diseases</a></span>         
                                      <span class="menu-service " onclick="location.href='../cardiac-surgery/index.html';"><a href="../cardiac-surgery/index.html"><i class="flaticon-right-chevron"></i>Cardiac Surgery</a></span>         
                                      <span class="menu-service " onclick="location.href='../radiology/index.html';"><a href="../radiology/index.html"><i class="flaticon-right-chevron"></i>Radiology</a></span>         
                                      <span class="menu-service " onclick="location.href='../dental-diseases/index.html';"><a href="../dental-diseases/index.html"><i class="flaticon-right-chevron"></i>Dental Diseases</a></span>         
                                      <span class="menu-service " onclick="location.href='../gynecology-obstetrics/index.html';"><a href="../gynecology-obstetrics/index.html"><i class="flaticon-right-chevron"></i>Gynecology & Obstetrics</a></span>         
                                      <span class="menu-service " onclick="location.href='../brain-surgery/index.html';"><a href="../brain-surgery/index.html"><i class="flaticon-right-chevron"></i>Brain Surgery</a></span>         
...
<div class="wpcf7-response-output" aria-hidden="true"></div></form></div>
          ...
          <div class="galeri wow fadeInRight" data-wow-delay="0.7s">
              <img src="../wp-content/uploads/2022/06/services2.png" alt="IT Support Services" class="galeri__gorsel galeri__gorsel--3">
          </div>
          <div class="bosluk3"></div>
          <h2 class="h2-baslik-anasayfa-ozel wow fade">Gastroenterology</h2>
          <div class="bosluk333"></div>
          <p class="paragraf wow fade">
          <p>Gastroenterology department; It is the section where the diseases of the digestive system organs (esophagus, stomach, small intestine, large intestine) and the liver, gall bladder and pancreas that help digestion are treated without the need for surgical intervention, either drug or endoscopically. In our Gastroenterology Department, gastroscopy, colonoscopy, follow-up of digestive system bleeding and emergency stop treatment, sclerosing treatment, treatment of varicose bleeding, treatment of chronic pancreatitis with ERCP method, treatment of biliary tract stones and stenosis, removal of stones from the bile ducts, removal of polypectomy in the stomach and intestines, Applications such as ulcer treatment, treatment of reflux disease, Crohn&#8217;s disease, treatment of ulcerative colitis, biliary tract, large intestine, small intestine and esophagus stent placement are performed. In addition, tube placement (PEG) is performed with the endoscopic method for patients who have nutritional problems and cannot take food by mouth.</p>
          </p>
              <div class="bosluk333"></div>
