    ...
    <div class="row">
        <div class="page-title justify-content-end">
            <ul class="d-flex align-items-center gap-20">
                ...
                <li class="bc-item"><a class="para-1b" href="{{ route('back_end.maux.index') }}">Maux</a></li>
                <li class="bc-item">Ajouter un mal</li>
            </ul>
        </div>

        <div class="bgnc-10 br-sm p-sm-30 p-10 col-md-9">
            <span class="heading-five mb-sm-30 mb-3">Ajouter un mal</span>
            <form action="{{ route('back_end.maux.store') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="row gy-20">
