                     ...
                     <div class="row mb-1">
                        ...
                        <div class="col-lg-12">
                           ...
                           <div class="input-group ">
                              ...
                              <input type="file" class="form-control  @error('photo') is-invalid @enderror" name="photo" placeholder="Votre photo" aria-label="photo" value="{{ old('photo', $administrateur ? $administrateur->photo : '') }}" aria-describedby="addon-wrapping" >
